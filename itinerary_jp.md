...
- **削除**：Rosenlaui + Reichenbach Falls + Rheinfall + Zurich 宿泊
- **新規**：**Pfingstegg Rodelbahn 鉱山ジェットコースター**（Grindelwald、妻指定）
- **航空券変更**：原「7/23 SWISS BCN→ZRH」実際未予約 → **7/25 BCN→ZRH SWISS** 未予約（ANA マイル）に変更
- ドイツ Frankfurt 2 泊維持（追加なし）
- v4.0 変更保持：ローマ 1 泊 + フィレンツェ 1 泊 + UA マイル FCO→ATH→JTR ビジネス（PNR AZZ0QN）
- v4.1 変更保持：Vueling JTR→BCN 7/20 月曜直行（予約済み）+ サントリーニ 7/18-20 第 2 ホテル 2 泊（v4.8 実際予約 = Sandblu LXR）

---

## ✈️ 航空券（発券済み、変更不可）

> **v4.4 確認**（2026-05-31）：5 区間 e-ticket PDF 揃え確認、PNR / 航空券番号 / 実時刻を e-ticket 通りに再記載
...
**支払い総計**：
- JAL Award（往路 + 帰路、2 名 EK + JL）：JPY 199,040 税金（¥47,430 + ¥52,090 各 × 2 名）
- UA MileagePlus：90,000 マイル + USD 122.80（FCO→JTR ビジネス / 2 名）
- AmEx ...2009：EUR 356.10（Vueling Fly Grande / 2 名）
- PayPal：EUR 566.20（SWISS Economy Classic / 2 名）
...
| 同行者 | パスポート | シェンゲン状況 |
|---|---|---|
| 1 | 中国 | **3 年マルチシェンゲン有効ビザ**保有（コピー + 旅程表 + ホテル予約持参で入国）|
| 2 | 日本 | **90 日免ビザ** |

→ **ビザ再取得不要**、22 日間 × 1 回は免ビザ 90 日上限よりはるかに少ない。
...
- **14:00 🏛️ ドゥカーレ宮殿 Palazzo Ducale**（✅ **予約済み** €70、時間指定 14:00）— 標準ルートで**嘆きの橋の内側を通過**して新牢獄へ — 妻の願望 ✓（嘆きの橋・内側）；⚠️ Vivaticket は **PRINT@HOME A4 全ページ印刷**が必要（ゲートでは 4 つ折りスキャン可）
...
- **11:30 ⛪ サンマルコ寺院**（✅ **予約済み** €60、完全券：本堂の黄金モザイク + **Pala d'Oro 黄金祭壇** + Loggia テラス；**入場枠 11:30-12:00**）— 妻の願望 ✓
...
- 🚧 17:00 ホテル到着後 day-by-day：**未策定**

---

### サントリーニ / Santorini（**4 泊** · Mystique LC 2N + Sandblu LXR 2N · 7/16-20 · 🚧 day-by-day 未策定 / 3 食確定）

> **v4.8 更新**：第 2 ホテル確定 = **Sandblu Santorini, LXR Hotels & Resorts** ✅ + honeymoon レストラン 3 軒確定 ✅
> - Mystique Oia 7/16-18 予約済み（**ウェットアルーアスイート**, conf #85281803, 324k pts）
> - Sandblu LXR 7/18-20 予約済み（Amex 旅程 #30633673 / 提携 #2477955383 / Deluxe Room 1 King Sea View 38m², ¥244,075 合計 = 前払 ¥238,534 + 現地 ¥5,541）
> - **FHR 特典**（2N+）：US$125 飲食クレジット / 部屋アップグレード / 12:00 アーリーチェックイン / レイトチェックアウト / 朝食 2 名 / 無料 valet & self-parking
> - **位置**：Ancient Thira / Pyrgos 地区（Imerovigli ではない）、山頂古代遺跡近く — Mystique のカルデラ縁 caldera view と視角異なる
>
> **🍽️ 予約済みレストラン（3 軒すべて honeymoon + front-row リクエスト / i-host.gr）**：
> - **7/17 (金) 18:30 Lycabettus @ Andronis**（Imerovigli 崖 fine dining、Cliff Area）— ref `1Iq_055oTQGziX3tkevg_w` / +30 22861 86602
>   - ⚠️ 130 段の階段、エレベーターなし；15 分以上遅刻席没収；48 時間前以降キャンセル料発生；13 歳未満 / ペット不可
> - **7/18 (土) 13:00 Sunset Ammoudi**（Ammoudi Bay シーフードランチ、赤崖青海下）— ref `QMfr8X2KTQa0UOU5sAXz9g` / +30 2286 071614
>   - Oia 下方 Ammoudi 漁村、300 段の階段（または driver 送迎）
> - **7/19 (日) 17:00 Kastro**（Oia 古城日没 "first line"）— ref `lWpO32ryT3iakU8fw83u-g` / +30 22860 71045
>   - ⚠️ 15 分以上遅刻席没収；no-show €45/人クレカ請求；最大滞在 2h；日没時間帯 18:00-20:30 最低消費 €45/人（7 月 Oia 日没 ~20:30）
>   - ⚠️ **予約名 = SAKODA AIRI**（来店時は妻の名前で）；**17:00 入席 + 最大 2h ≈ 19:00 退席、日没 20:30 は退席後** — テーブルで日没を見たい場合は現地で店と延長交渉、または退席後に古城展望スポットで
>
> day-by-day 詳細未策定（レストラン時間スロット確定、活動ペースこの 3 点中心に設計；Sandblu 期間は古城 + Akrotiri 火山遺跡 + Vlychada ビーチ可能）
...
- ✈️ **10:00 VY3315 JTR → 12:20 BCN T1**（PNR EKHTKG, Fly Grande, 座 1A/1B）— ⚠️ **チェックインカウンター 09:20 締切**（出発 40 分前；搭乗口は 20 分前締切）；確認メール≠搭乗券、事前オンラインチェックインを
...
- 11:45 🏨 チェックアウト → **12:00 🚕 taxi → BCN T1**（土曜昼 25-35 分、~€32-38）；⚠️ **免税書類が多い場合（LOEWE+指輪+ワイン）は 11:30 出発に前倒し推奨**
- ~12:35 T1 着（チェックイン締切 **14:10**；⚠️ 夏の土曜はセキュリティ 20-40 分待ちあり）
- ⚠️ **第一免税ステーション（v5.5 免税プラン）**：7/25 スイス行き = EU 関税圏を出る → **伊/希/西すべての Tax Free 書類を BCN T1 で処理**（検証してから荷物を預ける）：① スペイン分 → **DIVA 端末**（チェックインホール；スペインは最低購入額なし）② イタリア/ギリシャ分 → **税関カウンターで手動スタンプ**（パスポート+搭乗券+品物提示：指輪は手荷物・未着用、スーツケース内のワインは開けて提示できる状態に）→ 荷物預け → 保安検査後 Global Blue/Planet カウンターへ提出（**クレジットカード返金を選択**）；間に合わなかった書類は 7/30 FRA で補完可（ドイツ税関は EU 加盟国どの書類もスタンプ可）
- ⚠️ スイス入国の個人免税枠 **CHF 150/人**、7/28 列車でドイツ再入国（陸路 EU 再入域）の免税枠 **€300/人** — 正式ルールはこの通りで、超過分は自己責任のグレーゾーン（どこでスタンプしても同じ）
- ✈️ **14:55 LX1955 → 16:40 ZRH**（PNR 7BWRK8, 座 16D/E）→「スイス」7/25 へ続く

---

### スイス（3 泊 · **Zurich Marriott 1N + Wengen Belvedere 2N** · 7/25-28 · ✅ ホテル全予約 / day-by-day「シミュレーション A」確定）

> **v4.8.5 変更**：Bernese Oberland 拠点を「Lauterbrunnen 谷底独立（Silberhorn/Schweizerhof 候補）」→ **Grand Hotel Belvedere, a Beaumier Hotel**（**Wengen** 山上 5★ グランドホテル、2024 全面リノベ、conf **#5963.885.781** / PIN 4424、**Deluxe – Jungfrau View**, 1 Double, **朝食付**、¥289,456 / **CHF 1,434.32**、Booking.com 現金 / ⚠️ **キャンセル不可**）。Wengen は車なし村、ラックレールで上山、ユングフラウ線上。
> **景点確定「シミュレーション A」4 項目**（妻願望 Top5 の第 1/2/3/5）：#1 ユングフラウヨッホ · #2 Staubbach Falls · #3 Gelmerbahn（世界最急 106% ケーブルカー）· #5 Gimmelwald 車なし山村。カット：#4 Blausee + #6-10（跨州/逆方向で物理不可）

**7/25 (土) — チューリッヒ（軽い到着 😴）**
- SWISS LX1955 BCN 14:55 → ZRH 16:40（予約済み PNR 7BWRK8）→ 出国 / 荷物 → トラム / 徒歩 5 分 → **Zurich Marriott**（Neumuehlequai 42, #71467622, Superior King North Wing, 510 CHF）
- 夕方：Niederdorf 旧市街 + Limmat 河 / チューリッヒ湖畔散策 + ディナー、時差調整

**7/26 (日) — 専用車：Gelmerbahn + Wengen 移動（😐 適度）· ホテル到着 ~17:20**
- **~08:00 Zurich Marriott 朝食 → ~08:15 専用車出発**（荷物全車載）→ ルツェルン / **Brünig 景観線** → Meiringen → **Handegg（Gelmerbahn 山下駅）**、車程 ~2h15
- ~10:30 Handegg 駐車場到着 → ⚠️ **工事：徒歩 ~30 分**（急階段 / 仮設歩道）山下駅 ~11:00
- **~11:05-11:55 山下駅 Gasthaus ブランチ**（上山前「適当に」）；**voucher でチケット引換は発車 ≥15 分前（11:57 まで）**
- **12:12 🚡 Gelmerbahn 上山**（#2A55DFA4、106% 急傾斜 ~12 分 → 12:24）→ **Gelmersee 湖畔散歩 ~1h20**（青緑色湖 + 撮影）
- **14:00 🚡 下山**（→ 14:12 山下駅）→ 徒歩 ~30 分で駐車場 ~14:45
- ~14:45 ドライバーで Handegg → Meiringen → Interlaken → **Lauterbrunnen 駅**（~1h20、Wengen 車なし、専用車はここまで）~16:05
- ~16:10-16:55 **#2 Staubbach** 谷底徒歩で滝の脚へ（近距離水霧）；荷物は Belvedere の Lauterbrunnen 接送 / 預け
- ~17:00 ラックレール **Lauterbrunnen → Wengen** 12 分 → **~17:20 Belvedere チェックイン**（駅前ホテル接送）→ 夕方 onsen spa + ユングフラウ夕景 + ディナー
  - ⚠️ **Booking 予約上の到着予定は 14:00-15:00 と記載、実際は ~17:20 到着** — グラブアンドゴー朝食のメールを送る際に遅い到着も併せて連絡
- ⚠️ **ハード制約**：12:12 上山 + 30 分工事歩道 + チケット引換 → **最遅 ~11:10 必ず Handegg 駐車場に**（チューリッヒ ~08:30 前発車）；上山前ランチをゆっくり食べたい場合は ~08:15 発

**7/27 (月) — ユングフラウヨッホ + Gimmelwald（😓 やや疲れ、唯一ハード日）· 予約済み時刻便 #295536**
- ⚠️ **早便 07:46 Wengen 発** → ~07:25 出発（Belvedere にグラブアンドゴー朝食 / 早開きを依頼）；座席予約は**予約便のみ有効**、発車 10 分前到着、青「with seat reservation」マーク従う
- **07:46 Wengen（Pl.3, CC63）→ 08:08 Kleine Scheidegg → 08:28（Pl.21, CC65）→ 09:11 Jungfraujoch**（Good Morning, 2 等）
- **09:11-11:15 #1 Top of Europe（~2h）**：Sphinx 展望台 + 氷の宮殿 + Aletsch 氷河全景
- **11:15 Jungfraujoch → 11:54 Kleine Scheidegg → 12:14 → 12:38 Wengen（Pl.2）**（往復とも Wengen 線、Grindelwald 経由ではない）
- 12:38 Wengen 戻りランチ → 午後 **#5 Gimmelwald**：ラックレール下 Lauterbrunnen → バス Stechelberg → ケーブル Gimmelwald（車なし山村 ~2h）→ 夜 Wengen 戻り
- ⚠️ 標高 3454m、山頂ゆっくり歩き水多めに

**7/28 (火) — 出発（早出 😴）**
- 朝食 + ユングフラウ撮影 → **~9:30 出発**（谷底泊より ~15 分早い）→ ラックレール Wengen → Lauterbrunnen 12 分 → BOB → Interlaken Ost、**10:59 ICE 106**（予約済み）でフランクフルト

**未決事項**：① 専用車（ユーザー処理中）② ✅ **Gelmerbahn 予約済み**（12:12/14:00, #2A55DFA4, CHF 80）③ ✅ **ユングフラウ予約済み**（Good Morning, Wengen 07:46↔12:38, #295536, Amex）④ チケット確定：**バラ買い（Pass 不購入）**——ZRH→HB / 7/26 Lauterbrunnen→Wengen cog / 7/27 Gimmelwald ケーブル / 7/28 Wengen→Interlaken Ost 現場購入
...
- 🚄 10:59 Interlaken Ost → 16:09 Frankfurt Hbf（ICE 106 + 596、Mannheim 同ホーム乗換 7 分、1 等 12 号車 45/46 席）— ⚠️ 記名チケットのため**検札時にパスポート提示が必要**；Zugbindung で予約 2 便に厳格拘束、他便への乗車不可
...
- ⚠️ **旧メモ「18:00 出発」より 3h 前倒し — 第二免税ステーション（v5.5 免税プラン）**：主に **7/29 ドイツ購入分**（ドイツの最低購入額 €50.01）+ **7/25 BCN で間に合わなかった伊/希書類の補完**（ドイツ税関は最終 EU 出国点として EU 加盟国どの書類もスタンプ可）；伊/希/西の書類は**メインプランでは 7/25 BCN で処理済み**のはず、この日に全部を賭けない。流れ：税関スタンプ（預け荷物内の免税品は預ける前に提示）+ Global Blue/Planet カウンター（ハイシーズン 1h+ 待ちあり、T3 新ターミナルで余裕を持つ）；**未処理の指輪書類がある場合：手荷物・未着用・レシート+書類一式**
- 16:30 JAL ビジネス チェックイン → 保安検査 → ラウンジで夕食
- ✈️ **20:10 JL408 FRA T3 → NRT T2 7/31 16:15**（PNR EKWC4T、13h05）

---

## 🏨 ホテル総覧（v4.8.5 — 11 軒全予約 ✅）

| # | 日付 | 都市 | ホテル | ブランド | マリオット | 泊数 | 支払い | 状態 |
|---|---|---|---|---|---|---|---|---|
| 1 | 7/8 (水) | ミラノ MXP | **Sheraton Milan Malpensa Airport** | Sheraton | ✅ Cat 4 | 1 | 45k pts + €6 | ✅ 予約 #71359009 |
...
## 🍽️ トップレストランリスト（v4.8 — サントリーニ 3 軒予約済み / その他 60-90 日前必予約ミシュラン）
...
| 6b | 7/26 (日) | チューリッヒ → Gelmerbahn → Wengen | **専用車**（Marriott → Brünig 景観 → Gelmerbahn → Lauterbrunnen 駅、荷物随車）→ ラックレール 12 分 Wengen 上山（Belvedere）| 🚧 見積依頼 + 予約待ち |
| 7 | 7/28 (火) | Lauterbrunnen → フランクフルト | ✅ **ICE 106 + ICE 596 Mannheim 経由（Interlaken Ost 10:59 → Frankfurt Hbf 16:09、5h10、1 乗換・同プラットホーム Gleis 3→2）、12 号車, 座 45+46（両区間同位）** | 予約済み Sparpreis Europa **1 等** €211.78/2 名 · 予約番号 **878050552107** · チケットコード **K53YL8EZ** · 🎫 **DB Navigator App** + `Tickets/7:28 Lauterbrunnen → Frankfurt.txt` |

### LCC 手荷物重要事項
- **Aegean エコノミー**：手荷物 1 件 ≤8kg 含む、**Aegean Flex アップグレードまたは 23kg 預け追加必須**（予約時アップグレード、空港追加は 50%+ 高い）
- **Vueling Fly Grande**（予約済み ✅）：1 underseat (40×30×20) + 1 overhead 10kg (55×40×20) + **25kg 預け / 名** + Fast Track セキュリティ + 優先搭乗 + 変更無料（2h 前）
...
**ANA 片道 Star 連れ運賃**：2025-06-24 開放、マイル = RT の半分
...
## 💰 予算（ユーザー「上限なし / 必要に応じて」、参考値）

| カテゴリ | 推計 2 名 22 日 |
|---|---|
| マリオット 16 泊（ポイント + 現金混合）| ポイント残高次第、全ポイント仮定 ≈ 800k-1M pts |
...
## 📝 更新履歴
- **v4.8.5 (2026-06-06)**: Grand Hotel Belvedere Wengen 補予約（Beaumier 5★, Deluxe – Jungfrau View, 含朝食, #5963.885.781, ¥289,456 / CHF 1,434.32 Booking.com 現金不可退改）→ **11 軒 22 泊全予約完了 ✅**。スイス day-by-day「シミュレーション A」確定（#1 ユングフラウヨッホ + #2 Staubbach + #3 Gelmerbahn + #5 Gimmelwald）+ 7/26 専用車 + Gelmerbahn #2A55DFA4 + ユングフラウ #295536 予約済み
- **v4.8.4 (2026-06-06)**: JW Marriott Hotel Frankfurt 7/28-30 2N 予約済み（66k pts + 1 引換証、Innenstadt 中心）— 原 Roomers Frankfurt 代替
- **v4.8.3 (2026-06-06)**: Zurich Marriott 7/25-26 1N 予約済み（510 CHF 現金）— v4.2 取消「チューリッヒ宿泊」決定復活；Lauterbrunnen 3N → 2N 短縮
- **v4.8.2 (2026-06-06)**: サントリーニ honeymoon 3 食予約済み（Lycabettus 7/17 / Sunset Ammoudi 7/18 昼 / Kastro 7/19 日没）+ Restaurants/ フォルダ作成 + 同期協定 3 種拡張（Tickets + Hotels + Restaurants）
- **v4.8 (2026-06-06)**: ホテル 7/8-7/25 共 8 軒予約済み（17N）。多数 v4.6 計画と異なる物件：ミラノ Excelsior Gallia → MXP Sheraton 1N + Casa Brera LC 2N；ヴェネツィア Gritti → AC Hotel；フィ St. Regis → W Florence；ロ St. Regis Rome → Sheraton Parco de' Medici（FCO 横）；サン 7/18-20 Cavo Tagoo TBD → Sandblu LXR；バ Hotel Arts → EDITION（Born 地区）。day-by-day の check-in / check-out 位置、交通方式を実際ホテルに合わせ再配置（詳細 `INDEX.md` 主要変更表）。統一ルート級 `INDEX.md` + `INDEX_jp.md` で Tickets + Hotels 統合（旧サブフォルダ INDEX 廃止）+ 同期協定統合文書化
- **v4.7 (2026-06-06)**: サントリーニ以降旅程クリア再計画待ち（ユーザー決定）。修正：Santorini 到着日 = **7/16**（7/17 ではない、AZ720+A3368 e-ticket 通り）；Santorini 合計 **4 泊**（Mystique 2N + Cavo Tagoo 2N、3 泊ではない、旧 header 誤り）；イタリア区間は v4.6 確定維持
- v4.6 (2026-05-31): 全イタリア高速鉄道予約済み + ミラノ/ヴェネツィア/フィレンツェ/ローマ day-by-day 確定 + 都市配分 3-2-2-1
- v4.5 (2026-05-31): DB ICE 7/28 予約済み — ICE 106 + ICE 596 Mannheim 経由同プラットホーム乗換（Interlaken Ost 10:59 → Frankfurt Hbf 16:09）、Sparpreis Europa 1 等 €211.78/2 名、チケット DB Navigator App
- v4.4 (2026-05-31): 全 5 区間 e-ticket 揃え確認、PNR/航空券番号/実時刻 PDF 通り再記載（帰路 JL408 修正：20:10/16:15）
- v3.0 (2026-04-26): サントリーニ Mystique 2N + Cavo Tagoo 1N 確定；Lauterbrunnen 区間独立精品修正（Bernese Oberland マリオットなし）；マリオットカバー率 16/21
- v2.x: Bulgari 取消 → Excelsior Gallia；Athens 宿泊削除
- v1.0: 初版 4 か国 22 日間フレーム
